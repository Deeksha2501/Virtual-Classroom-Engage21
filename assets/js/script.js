const roleButton = document.getElementsByName('role');
const hiddenElement = document.getElementById('student_specific')

// console.log(roleButton)

// roleButton.forEach(element => element.onclick = function() {
// 	console.log(this.value);
// })

for(let i = 0; i < roleButton.length; i++) {
	roleButton[i].onclick = function() {
		console.log(this);
		if(this.value.toLowerCase() == "student") {
...
{/* <input type="radio" id="student" name="role" value="student"></input> */}
